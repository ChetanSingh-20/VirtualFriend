...
def wall():
    ...
    a = sr.Recognizer()
    print("listening..")
    with sr.Microphone() as sp:
        au_wal = a.record(sp, duration = 5)
        print("Recognizing...")
...
def wishMe():
    ...
    speak('i am i smart. Please tell me how may i help you')
...
if 1:
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            print("akilesh kumar sir")
            speak("akilesh kumar sir")
            ...
            speak("i am ismart sankar with 24 megahartaz, and i have 4 terawite memory")

        elif 'what' in query:
            webbrowser.open(query)

        elif 'open photos folder' in query:
